  ...
  return (
    <div>
      <div className="page-header">
        ...
        <p>Your personal health dashboard and Health Dashboard</p>
      </div>
      ...
      <div className="grid-2" style={{ marginBottom: 24 }}>
        ...
        {/* Health Stats / Health Dashboard */}
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          <div className="glass-card animate-in glow-teal">
            <h3 style={{ fontSize: 16, fontWeight: 700, marginBottom: 16, display: 'flex', alignItems: 'center', gap: 8 }}>
              <Heart size={18} style={{ color: '#ef4444' }} /> Health Dashboard
            </h3>
      ...
      <div className="glass-card animate-in" style={{ marginBottom: 24 }}>
        <h3 style={{ fontSize: 16, fontWeight: 700, marginBottom: 12, display: 'flex', alignItems: 'center', gap: 8 }}>
          <Users size={18} color="#06b6d4" /> Family Members
        </h3>
