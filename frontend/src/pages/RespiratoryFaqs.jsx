...
export default function RespiratoryFaqs() {
    ...
    const filteredFaqs = useMemo(() => {
        ...
        return faqItems
            ...
            .filter((item) => !query || `${item.question} ${item.answer} ${item.category}`.toLowerCase().includes(query))
    }, [category, search])
    ...
    return (
        <div>
            <div className="page-header">
                ...
                <p>Practical, field-friendly guidance for cough, wheezing, asthma, pneumonia, COPD, TB, oxygen checks, and urgent warning signs.</p>
            </div>
            ...
            <div className="grid-3 animate-in" style={{ marginBottom: 20 }}>
                <div className="glass-card stat-card" style={{ padding: 18 }}>
                    ...
                    <div className="stat-label">Expanded Questions</div>
                </div>
                <div className="glass-card stat-card" style={{ padding: 18 }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'minmax(240px, 1fr) auto', gap: 12, alignItems: 'center', marginBottom: 14 }}>
                    <div style={{ position: 'relative' }}>
                        ...
                        <input
                            ...
                            placeholder="Search cough, oxygen, TB, inhaler..."
                            value={search}
